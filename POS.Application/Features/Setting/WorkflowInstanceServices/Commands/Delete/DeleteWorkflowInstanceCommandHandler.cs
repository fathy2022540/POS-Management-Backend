...
namespace POS.Application.Features.WorkflowInstanceServices.Commands.Delete
{
    public record DeleteWorkflowInstanceCommand(long Id) : IRequest<ApiResponses<bool>>;

    public class DeleteWorkflowInstanceCommandHandler(IUnitOfWork<POSDBContext> unitOfWork)
